...
public class CustomIsometricTiledMapRenderer extends BatchTiledMapRenderer {
	private float[] vertices = new float[20];
	
	private float unitScaleX = 1f;
	private float unitScaleY = 1f;
	
	public CustomIsometricTiledMapRenderer(TiledMap map) {
		super(map);
	}
	
	public CustomIsometricTiledMapRenderer(TiledMap map, float unitScaleX, float unitScaleY) {
		super(map);
		this.unitScaleX = unitScaleX;
		this.unitScaleY = unitScaleY;
	}

	public CustomIsometricTiledMapRenderer(TiledMap map, Batch batch) {
		super(map, batch);
	}

	public CustomIsometricTiledMapRenderer(TiledMap map, float unitScale) {
		super(map);
		this.unitScaleX = unitScale;
		this.unitScaleY = unitScale;
	}	

	public CustomIsometricTiledMapRenderer(TiledMap map, float unitScale, Batch batch) {
